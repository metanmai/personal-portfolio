...
const menuItems = [
    ...
    { num: '02', label: 'FIELD OPERATIONS', hint: 'deployments', path: '/projects' },
    { num: '03', label: 'PERSONNEL FILE', hint: 'classified', path: '/personnel', locked: true },
    { num: '04', label: 'SUBJECT SURVEILLANCE', hint: 'live feed', path: '/monitor' },
